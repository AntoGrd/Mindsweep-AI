...
def summarize_all_articles(articles, model="gpt-5-mini-2025-08-07"):
    ...
    prompt = (
        ...
        "IMPORTANT : Génère le résumé directement au format HTML, prêt à être utilisé comme corps d’e-mail (utilise des balises <h2>, <b>, <ul>, <li>, <p>, etc. pour la structure et la lisibilité, évite le markdown).\n\n"
        f"Références :\n{refs}\n\nContenus :\n{contents}"
    )
